...
### Basic Express App
1. Create a new directory inside gravytrain called "superheroes"
1. cd into superheroes
1. perform an npm init, specify server.js as your entry (what property does nodemon have to watch)
1. install express
